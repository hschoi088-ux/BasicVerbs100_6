...
<body oncontextmenu="return false">
    ...
    <div class="max-w-md mx-auto px-4 py-6">
        ...
        <div class="flex space-x-2 mb-6 overflow-x-auto pb-2 no-scrollbar font-bold text-sm">
            <button onclick="selectWeek('w5')" id="tab-w5" class="week-tab flex-shrink-0 px-5 py-2 bg-white rounded-full shadow-sm border border-slate-100 active-tab">Week 5</button>
            <button onclick="selectWeek('w6')" id="tab-w6" class="week-tab flex-shrink-0 px-5 py-2 bg-white rounded-full shadow-sm border border-slate-100">Week 6</button>
            <button onclick="selectWeek('total2')" id="tab-total2" class="week-tab flex-shrink-0 px-5 py-2 bg-white rounded-full shadow-sm border border-slate-100">W5-6 누적</button>
        </div>
    ...
    <script>
        ...
        function selectWeek(mode) {
            ...
            else if(mode === 'total2') titleEl.innerText = "WEEK 5-6 (Month 2 Accumulated)";
        }
        ...
        function startQuiz(difficulty) {
            ...
            else if (selectedWeekMode === 'total2') weekFiltered = allData.filter(item => item.d >= 21 && item.d <= 30);
